...
SITES: tuple[Site, ...] = (
    ...
    Site("backend/uv.lock", r'name = "k-shui"\nversion = "(?P<version>[^"]+)"', "locked Python project"),
    Site("frontend/package-lock.json", r'^  "version": "(?P<version>[^"]+)"', "npm lockfile version"),
    Site("frontend/package-lock.json", r'^      "version": "(?P<version>[^"]+)"', "npm locked root package"),
